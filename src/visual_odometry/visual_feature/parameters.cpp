...
void readParameters(ros::NodeHandle &n)
{
    ...
    n.getParam("vins_config_file", config_file);//读取配置文件,module_san.launch找到一个参数的设置
    cv::FileStorage fsSettings(config_file, cv::FileStorage::READ);//通过cv::FileStorage读取里面的yaml格式的各种参数信息。params_camera.yaml文件
